...
export default defineConfig((/* ctx */) => {
  return {
    ...
    build: {
      ...
      vueRouterMode: 'history', // 'hash' collides with Telegram's own use of the URL fragment for initData
      // vueRouterBase,
    ...
    devServer: {
      ...
      proxy: {
        '/api': {
          // Local dev: `php artisan serve --port=8010`. In docker-compose
          // this is overridden to the api-nginx service name.
    ...
    framework: {
      config: {
        dark: false, // force light theme — Telegram/device dark mode was making body text illegible
      },
